...
class BackgroundDispatcher:
    ...
    # =====================================================
    # hallucinated_call risk
    # renamed method
    # =====================================================

    def _build_and_push_runtime_update(
        self,
        conversation_id,
        decision_trace_id,
        requirements,
        ...
        try:
                ...
                updates.append(
                    {
                        ...
                        "workload_fit": recommendation.get(
                            "workload_fit"
                        ),
                        "upgrade_implications": recommendation.get(
                            "upgrade_implications"
                        ),
                        "assumptions": recommendation.get(
                            "assumptions"
                        ),
            ...
            payload = (
                ...
                .build_recommendation_update_payload(
                    decision_trace_id=decision_trace_id,
                    recommendation_updates=updates,
                    meta={
                        # =====================================================
                        # cross_file_consistency risk
                        # camelCase metric naming
                        # =====================================================
                        "backgroundTimingMs": {
                            "queueDelayMs": round(
                                (
            ...
            async_to_sync(
                ...
                {
                    "type": (
                        "background_recommendation_update"
                    ),
                    "payload": payload,
                },
            )
            ...
            # =====================================================
            # dead_abstraction risk
            # useless wrapper abstraction
            # =====================================================

            self._normalize_runtime_payload(
                payload
            )
